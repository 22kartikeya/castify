    ...
    <div>
      <div className="-m-1.5 overflow-visible">
        <div className="p-1.5 min-w-full inline-block align-middle">
          <div className="overflow-hidden rounded-2xl bg-white/5 backdrop-blur-2xl border border-white/10 shadow-2xl">
            <table className="min-w-full divide-y divide-white/10 rounded-2xl">
                ...
                {data.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 whitespace-nowrap text-sm text-white/90 hover:text-white transition-colors duration-300">
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-blue-400/15 text-blue-200 border border-blue-300/20 backdrop-blur-sm shadow-lg ring-1 ring-blue-400 hover:bg-blue-400/25 hover:scale-105 hover:shadow-xl transition-all duration-300">
                        {item.type}
                      </span>
                    </td>
                    <td className="px-4 py-2 whitespace-nowrap text-sm text-white/90 hover:text-white transition-colors duration-300">
                      <span
                        className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold backdrop-blur-sm shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-300 ${
                          item.status === "active"
                            ? "bg-emerald-400/15 text-emerald-200 border border-emerald-300/20 ring-1 ring-emerald-400 hover:bg-emerald-400/25"
                            : "bg-rose-400/15 text-rose-200 border border-rose-300/20 ring-1 ring-rose-400 hover:bg-rose-400/25"
                        }`}
                      >
                        {item.status}
                      </span>
                    ...
                    >
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <button
                          type="button"
                          className="inline-flex items-center px-3 py-1 text-xs font-semibold rounded-xl bg-amber-400/15 text-amber-200 border border-amber-300/20 backdrop-blur-sm hover:bg-amber-400/30 hover:text-amber-100 hover:border-amber-200/40 hover:shadow-xl hover:scale-110 focus:outline-none focus:ring-2 focus:ring-amber-300/50 focus:ring-offset-2 focus:ring-offset-transparent transition-all duration-300 ease-out ring-1 ring-amber-400 cursor-pointer"
                        >
                          Edit
                        </button>
                      </div>
